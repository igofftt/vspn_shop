	...
	var b  = function() {
		...
		return function() {
			...
			return b.Extend(c, b.Observable), c.prototype.render = function() {
				...
				this.$results.attr("id", e), b.on("results:all", function(a) {
					...
					if(!(e >= b.length)) {
						var f = b.eq(e);
						f.trigger("mouseenter");
						var g = d.$results.offset().top + d.$results.outerHeight(!1), h = f.offset().top + f.outerHeight(!1),
			...
			return b.prototype.query = function(a, b, c) {
				function d(a, f) {
					for(var g = a.results, h = 0; h < g.length; h++) {
						var i = g[h], j = null != i.children && !d({results: i.children}, !0), k = (i.text || "").toUpperCase(),
								l = (b.term || "").toUpperCase(), m = k === l;
			...
			return c.prototype.bind = function(a, b, c) {
				...
				var h = {height: this.$dropdown.outerHeight(!1)}, i = {top: b.scrollTop(), bottom: b.scrollTop() + b.height()},
